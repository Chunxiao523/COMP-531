...
/***/ function(module, exports, __webpack_require__) {
	...
	var _slicedToArray = function () { function sliceIterator(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"]) _i["return"](); } finally { if (_d) throw _e; } } return _arr; } return function (arr, i) { if (Array.isArray(arr)) { return arr; } else if (Symbol.iterator in Object(arr)) { return sliceIterator(arr, i); } else { throw new TypeError("Invalid attempt to destructure non-iterable instance"); } }; }(); //single function
...
/***/ function(module, exports) {
	...
	var update = function update(_ref2, delta, _ref3) {
		...
		var _velocity2 = _slicedToArray(_velocity, 2);
	
		var v_x = _velocity2[0];
		var v_y = _velocity2[1];
		var _acceleration = acceleration;
	
		var _acceleration2 = _slicedToArray(_acceleration, 2);
	
		var a_x = _acceleration2[0];
		var a_y = _acceleration2[1];
